...
from app.import_process.agent.nodes.node_build_kg import node_build_kg  # 知识图谱：实体关系抽取写入Neo4j（可选/未配置则跳过）
...
workflow.add_edge("node_item_name_recognition","node_build_kg")
workflow.add_edge("node_build_kg","node_bge_embedding")
